    ...
    <div>
      ...
      <div className="hidden md:block">
        <header className="bg-white">
          <div className="container px-32  py-3 flex items-center">
            {/* logo */}
            <div className="cursor-pointer mr-auto md:w-48 flex items-center gap-4">
              <img
                className="h-8 md:h-10"
                src="../../public/images/logo"
                alt=""
              />
              <div onClick={() => navigate("/")} className="font-bold font-sans font-lg ">Yummers</div>
            </div>
            {/* search */}
            <div>{children}</div>
            ...
            <nav className="contents">
              ...
              <li className="ml-2 lg:ml-4 relative inline-block">
                  <Link className="cursor-pointer" onClick={() => navigate("/cart")}>
                ...
                {/* Orders */}
                <li className="ml-2 lg:ml-4 relative inline-block">
                  <Link className="cursor-pointer" onClick={() => navigate("/orders")}>
                    <div className="absolute -top-1 right-0 z-10 bg-yellow-400 text-xs font-bold px-1 py-0.5 rounded-sm">
                      3
                    </div>
                    <svg
