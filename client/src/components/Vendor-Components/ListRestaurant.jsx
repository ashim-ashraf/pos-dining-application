          ...
          <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
            <div className="flex flex-wrap justify-center">
              <div className="w-full lg:w-9/12 px-4">
                ...
                <Link to={'/vendors/registration'} className="px-8 py-3 bg-gradient-to-r from-green-400 to-blue-500 hover:from-emerald-500 hover:to-cyan-500  text-white rounded-full mr-4">Manage</Link>
              </div>
            </div>
          </div>
        </div>
