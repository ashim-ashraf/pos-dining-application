...
import { logout as clearuser } from "../features/user/userSlice";
    ...
    <div className="bg-blue-500">
      <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
        ...
        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
          ...
          <li>{user.isLoggedIn ? user.user?.name : ""}</li>
        </ul>
        ...
        {user.isLoggedIn ? (
          ...
          <Link to={"/login"} className="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200">
            Signin
          </Link>
        )}
      </nav>
